  ...
  return (
    <div className="min-h-screen w-full bg-[#FAFAFA] flex flex-col antialiased">
      ...
      <main className="flex-1 flex flex-col items-center justify-center p-4 md:p-8">
        ...
        <section className="w-full max-w-4xl min-h-[70vh] flex flex-col justify-center items-center bg-white rounded-xl border border-[#EBEBEB] shadow-[0_2px_8px_rgba(0,0,0,0.04)] px-6 py-10 md:px-12 md:py-16 transition-all duration-300">
          ...
          <div className="w-full max-w-[540px] flex flex-col items-stretch">
            <Proces1 />
          </div>
