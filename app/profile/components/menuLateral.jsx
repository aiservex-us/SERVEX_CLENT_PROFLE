  ...
  return (
    <>
      ...
      <aside
        ...
        `}
      >
        {/* HEADER: LOGO & TOGGLE (El botón de aquí se oculta en móvil para usar el flotante de arriba) */}
        <div className="h-16 flex items-center px-4 shrink-0 relative">
          ...
          {/* Este es tu botón original: Ahora solo se renderiza en pantallas MD o superiores */}
          <button
            onClick={() => setCollapsed(!collapsed)}
          ...
          {filteredItems.map(item => {
            ...
            return (
              <button
                ...
                onClick={() => {
                  setActive(item.id);
                  // Opcional: Cierra el menú automáticamente tras seleccionar en móvil
